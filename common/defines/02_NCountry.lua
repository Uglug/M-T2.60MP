NDefines.NGovernment.GOVERNMENT_REFORM_CHANGE_CORRUPTION = 3		-- was 10
...
NDefines.NCountry.MAX_TOLERANCE_HERETIC = 100 						-- maximum tolerance towards heretics
NDefines.NCountry.MAX_TOLERANCE_HEATHEN = 100 						-- maximum tolerance towards heathens
...
NDefines.NCountry.NEIGHBOURBONUS_CAP = -0.05 						-- _CDEF_NEIGHBOURBONUS_CAP_
...
NDefines.NCountry.TARIFF_LIBERTY_INCREASE = 1.0						-- Liberty increase for each % tariffs (was 1)
...
NDefines.NCountry.LIBERTY_DESIRE_ADM_EFFICIENCY = 0.2				-- Liberty desire per point of admistrative efficiency (colonies only) (was 0.2)
...
NDefines.NCountry.NAVAL_ATTRITION_ALERT_HULL = 70					-- The value in % a ship's hull has to be down to for the alert to pop up
...
NDefines.NCountry.FREE_POLICIES_PER_CATEGORY = 0 							-- Available free policies per monarch power category
